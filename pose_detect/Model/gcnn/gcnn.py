...
class GCNN(nn.Module):
    ...
    def __init__(self, cfg, optim_spec=None):
        ...
        self.feature_length = {
            ...
            'lo_ori_reg_result': 2,
            'lo_ori_cls_result': 2,
            'lo_centroid_result': 3,
            'lo_coeffs_result': 3,
            'lo_afeatures': 2048,
            'size_reg_result': 3,
            'ori_reg_result': 6,
            'ori_cls_result': 6,
            'centroid_reg_result': 6,
            'centroid_cls_result': 6,
            'offset_2D_result': 2,
            'odn_afeature': 2048,
            'odn_rfeatures': 2048,
            'odn_arfeatures': 2048,
            'ldif_afeature': 1536,  # ldif.bottleneck_size
            'analytic_code': 320,  # ldif.element_count * 10
            'blob_center':
            (32 + 16) * 3,  # (ldif.element_count + ldif.sym_element_count) * 3
            'ldif_phy': (32 + 16) //
