...
from Lib.tools import cvt2nyuclass_map, get_inst_classes, get_world_R
import numpy as np
import random
...
nyuclass_mapping = np.load('../implicit-3d-understanding/data/nyu40class_mapping.npy')
...
colorbox_path = '../implicit-3d-understanding/external/cooperative_scene_parsing/evaluation/vis/nyu_colorbox.mat'
